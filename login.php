...
<body style="background-image: url('images/bglogin.jpg');  background-repeat: no-repeat;
  ...
  <div class="d-flex justify-content-center form-containerr">
    <div class="col-md-5 border p-5 my-5 bg-white">
      <div class="card-body justify-content-center">
        ...
        <div class="regis">Belum daftar?<a href="registration.php" style="color:#f30;"> Buat akun </a></div>
