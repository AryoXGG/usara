    ...
    <nav class="navbar top-navbar navbar-expand-md navbar-">
        ...
        <div class="navbar-collapse">
            ...
            <ul class="navbar-nav my-lg-0">
                ...
                <!-- Profile -->
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle text-muted  " href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="images/admlogout.png" alt="user" class="profile-pic" /></a>
