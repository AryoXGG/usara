    ...
    <div class="page-wrapper">
        ...
        <div class="top-links">
            <div class="container">
                ...
                <li class="col-xs-12 col-sm-4 link-item"><span>3</span><a href="#">Pesan dan Bayar Online</a></li></ul>
            </div>
        </div>
        <!-- end:Top links -->
        ...
        ?>
        <section class="inner-page-hero bg-image" data-image-src="images/bgresto.jpg">
            <div class="profile">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 profile-desc">
                            <div class="pull-left right-text white-txt">
                                ...
                                <ul class="nav nav-inline">
                                    <li class="nav-item"> <a class="nav-link active" href="#"><i class="fa fa-check"></i> Min Rp.10.000</a> </li>
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 col-lg-6">
                    ...
                    <div class="menu-widget" id="2">
                        <div class="widget-heading">
                            <h3 class="widget-title text-dark">
                                Daftar Menu  <a class="btn btn-link pull-right" data-toggle="collapse" href="#popular2" aria-expanded="true">
